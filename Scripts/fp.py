...
class globalTCPaths(object):
    ...
    sqmLibApplication = os.path.join(testRoot, 'Bin', 'SQMLib', 'Linux', 'SQM')
    testResultFileName = os.path.join(testReportDir, 'test_Results.csv')

    testDataDir = os.path.join(testRoot, "TestData")
    if ((sys.platform == 'win32') or (sys.platform == 'win64')):
	    testDataDir = os.path.join("C:\\Users\\liuxu\\Documents\\OneDrive\\QualityTesting\\TestData")
    ...
    def __init__(self):
        ...
        if ((sys.platform == 'win32') or (sys.platform == 'win64')):
            ...
            self.sqmLibApplication = os.path.join(self.testRoot, 'Bin', 'SQMLib', 'Windows', 'SQM.exe')
...
class globalTCFunctions(object):
    ...
    def verifyReportCsvPair(self, testReportPath, goldReportPath):
        ...
        try:
            ...
            deviceName = ["default", "Default", "SSIMplusCore", "SSIMplus Core", "SSIMplus"]
