...
class TC_11_2_Class(object):
    ...
    def run_TC_11_2(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify Repeated options:\n")
...
TC_11_2_ClassObject = TC_11_2_Class()
