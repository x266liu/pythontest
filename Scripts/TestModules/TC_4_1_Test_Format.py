...
class TC_4_1_Class(object):
    ...
    def run_TC_4_1(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different Formats videos:\n")
...
TC_4_1_ClassObject = TC_4_1_Class()
