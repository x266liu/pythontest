...
class TC_9_1_Class(object):
    ...
    def run_TC_9_1(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify Auto Temporal Alignment videos:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            # If the process takes longer than 15000 seconds kill it and print the output so far

            try:
                outs, errs = test_1.communicate(timeout=15000)                
...
TC_9_1_ClassObject = TC_9_1_Class()
