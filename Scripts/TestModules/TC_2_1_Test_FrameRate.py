...
class TC_2_1_Class(object):
    ...
    def run_TC_2_1(self, elemetnAttributeDictionary):
        ...
        if fp.produceGolden == 1:
            ...
            for INDEX1 in range(numberOfVideos):
                yuvvideoCommandList = [fp.paths.splTestApplication, os.path.join(fp.paths.testDataDir,"2-FrameRate" ,yuvdistortedVideosList[INDEX1]), os.path.join(fp.paths.testDataDir,"2-FrameRate",yuvreferenceVideosList[INDEX1] )]
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,"2-FrameRate" ,referenceVideosList[INDEX]), "-d", os.path.join(fp.paths.testDataDir,"2-FrameRate", distortedVideosList[INDEX])]
...
TC_2_1_ClassObject = TC_2_1_Class()
