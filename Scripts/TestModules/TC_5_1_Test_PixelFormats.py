...
class TC_5_1_Class(object):
    ...
    def run_TC_5_1(self, elemetnAttributeDictionary):
        ...
        if fp.produceGolden == 1:
            ...
            for INDEX1 in range(numberOfVideos):
                yuvvideoCommandList = [fp.paths.splTestApplication, os.path.join(fp.paths.testDataDir,folder, yuvdistortedVideosList[INDEX1]), os.path.join(fp.paths.testDataDir,folder,yuvreferenceVideosList[INDEX1] )]
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder ,referenceVideosList[INDEX]), "-d", os.path.join(fp.paths.testDataDir,folder, distortedVideosList[INDEX])]
...
TC_5_1_ClassObject = TC_5_1_Class()
