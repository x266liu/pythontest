...
class TC_9_14_Class(object):
    ...
    def run_TC_9_14(self, elemetnAttributeDictionary):
        ...
        print("Test case " + tcNumber + ": Test SQOQ: ")
        generateTestResultFile.testResultObject.writeInTestFile("\n")
        generateTestResultFile.testResultObject.writeInTestFile(",,SQOQ Test:\n")
...
TC_9_14_ClassObject = TC_9_14_Class()
