...
class TC_9_13_Class(object):
    ...
    def run_TC_9_13(self, elemetnAttributeDictionary):
        ...
        print("Test case " + tcNumber + ": Test Speed: ")
        generateTestResultFile.testResultObject.writeInTestFile("\n")
        generateTestResultFile.testResultObject.writeInTestFile(",,Speed Test:\n")
...
TC_9_13_ClassObject = TC_9_13_Class()
