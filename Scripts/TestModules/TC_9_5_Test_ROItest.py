...
class TC_9_5_Class(object):
    ...
    def run_TC_9_5(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,ROI test:\n")
...
TC_9_5_ClassObject = TC_9_5_Class()
