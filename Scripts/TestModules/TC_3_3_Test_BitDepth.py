...
class TC_3_3_Class(object):
    ...
    def run_TC_3_3(self, elemetnAttributeDictionary):
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,"3-BitDepth" , referenceVideosList[0]), "-d", os.path.join(fp.paths.testDataDir,"3-BitDepth", distortedVideosList[INDEX])]
...
TC_3_3_ClassObject = TC_3_3_Class()
