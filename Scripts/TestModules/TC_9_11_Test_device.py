...
class TC_9_11_Class(object):
    ...
    def run_TC_9_11(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,ReportFile Test:\n")
...
TC_9_11_ClassObject = TC_9_11_Class()
