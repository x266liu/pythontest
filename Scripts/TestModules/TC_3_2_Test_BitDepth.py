...
class TC_3_2_Class(object):
    ...
    def run_TC_3_2(self, elemetnAttributeDictionary):
        ...
        if fp.produceGolden == 1:
            ...
            for INDEX1 in range(numberOfVideos):
                yuvvideoCommandList = [fp.paths.splTestApplication, os.path.join(fp.paths.testDataDir,"3-BitDepth" , yuvdistortedVideosList[INDEX1]), os.path.join(fp.paths.testDataDir,"3-BitDepth",yuvreferenceVideosList[INDEX1] )]
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,"3-BitDepth" ,referenceVideosList[INDEX]), "-d", os.path.join(fp.paths.testDataDir,"3-BitDepth",distortedVideosList[INDEX])]  
...
TC_3_2_ClassObject = TC_3_2_Class()
