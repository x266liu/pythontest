...
class TC_11_1_Class(object):
    ...
    def run_TC_11_1(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify unsupport option videos:\n")
...
TC_11_1_ClassObject = TC_11_1_Class()
