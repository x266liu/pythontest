...
class TC_5_2_Class(object):
    ...
    def run_TC_5_2(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different Pixel Formats videos:\n")
        ...
        if fp.produceGolden == 1:
            ...
            for INDEX1 in range(numberOfVideos):
                ...
                if INDEX1 >= 25:                                 
                    yuvvideoCommandList = [fp.paths.splTestApplication,os.path.join(fp.paths.testDataDir,folder,yuvdistortedVideosList[INDEX1]) , os.path.join(fp.paths.testDataDir,folder ,yuvreferenceVideosList[5] )]
                elif INDEX1 >= 20:
                    yuvvideoCommandList = [fp.paths.splTestApplication,os.path.join(fp.paths.testDataDir,folder,yuvdistortedVideosList[INDEX1]) , os.path.join(fp.paths.testDataDir,folder ,yuvreferenceVideosList[4] )]
                elif INDEX1 >= 15:
                    yuvvideoCommandList = [fp.paths.splTestApplication,os.path.join(fp.paths.testDataDir,folder,yuvdistortedVideosList[INDEX1]) , os.path.join(fp.paths.testDataDir,folder ,yuvreferenceVideosList[3] )]
                elif INDEX1 >= 10:
                    yuvvideoCommandList = [fp.paths.splTestApplication,os.path.join(fp.paths.testDataDir,folder,yuvdistortedVideosList[INDEX1]) , os.path.join(fp.paths.testDataDir,folder ,yuvreferenceVideosList[2] )]
                elif INDEX1 >= 5:
                    yuvvideoCommandList = [fp.paths.splTestApplication,os.path.join(fp.paths.testDataDir,folder,yuvdistortedVideosList[INDEX1]) , os.path.join(fp.paths.testDataDir,folder ,yuvreferenceVideosList[1] )]
                else:    
                    yuvvideoCommandList = [fp.paths.splTestApplication,os.path.join(fp.paths.testDataDir,folder,yuvdistortedVideosList[INDEX1]) , os.path.join(fp.paths.testDataDir,folder ,yuvreferenceVideosList[0] )]
        ...
        for INDEX in range(numberOfVideos):
            ...
            if INDEX >= 25:                                 
                videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder ,referenceVideosList[5]), "-d", os.path.join(fp.paths.testDataDir,folder,distortedVideosList[INDEX])]
            elif INDEX >= 20:
                videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder ,referenceVideosList[4]), "-d", os.path.join(fp.paths.testDataDir,folder,distortedVideosList[INDEX])]
            elif INDEX >= 15:
                videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder ,referenceVideosList[3]), "-d", os.path.join(fp.paths.testDataDir,folder,distortedVideosList[INDEX])]
            elif INDEX >= 10:
                videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder ,referenceVideosList[2]), "-d", os.path.join(fp.paths.testDataDir,folder,distortedVideosList[INDEX])]
            elif INDEX >= 5:
                videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder ,referenceVideosList[1]), "-d", os.path.join(fp.paths.testDataDir,folder,distortedVideosList[INDEX])]
            else:    
...
TC_5_2_ClassObject = TC_5_2_Class()
