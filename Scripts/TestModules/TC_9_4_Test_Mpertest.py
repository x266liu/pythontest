...
class TC_9_4_Class(object):
    ...
    def run_TC_9_4(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,MeasurementPeriod Test:\n")
...
TC_9_4_ClassObject = TC_9_4_Class()
