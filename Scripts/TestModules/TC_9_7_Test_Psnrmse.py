...
class TC_9_7_Class(object):
    ...
    def run_TC_9_7(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,PSNR&MSE video Test:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            if(INDEX<4):
                ...
                videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder ,referenceVideosList[1]), "-d", os.path.join(fp.paths.testDataDir,folder,distortedVideosList[0])]    
...
TC_9_7_ClassObject = TC_9_7_Class()
