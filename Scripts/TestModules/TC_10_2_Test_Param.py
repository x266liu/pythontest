...
class TC_10_2_Class(object):
    ...
    def run_TC_10_2(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,YUV Param Test:\n")
...
TC_10_2_ClassObject = TC_10_2_Class()
