...
class TC_12_1_Class(object):
    ...
    def run_TC_12_1(self, elemetnAttributeDictionary):
        ...
        #print("numberOfVideos = ", numberOfVideos, "expectedcount = ", expectedcount)
        ################ Test Command ################
        ...
        for INDEX in range(numberOfVideos):
            ...
            if INDEX<10:
                    ...
                    ref_Idx = 5
                    test_Idx = 7
            #print("INDEX = ", INDEX, "ref_Idx = ", ref_Idx, "test_Idx = ", test_Idx)
...
TC_12_1_ClassObject = TC_12_1_Class()
