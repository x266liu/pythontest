...
class TC_7_1_Class(object):
    ...
    def run_TC_7_1(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,Test and verify different Druations videos:\n")
...
TC_7_1_ClassObject = TC_7_1_Class()
