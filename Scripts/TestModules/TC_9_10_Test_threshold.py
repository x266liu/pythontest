...
class TC_9_10_Class(object):
    ...
    def run_TC_9_10(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,QualityThreshold Test:\n")
...
TC_9_10_ClassObject = TC_9_10_Class()
