...
class TC_9_3_Class(object):
    ...
    def run_TC_9_3(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,video Frame2Process Test:\n")
        ...
        for INDEX in range(numberOfVideos):
            ...
            videoCommandList = [fp.paths.sqmLibApplication, "-r", os.path.join(fp.paths.testDataDir,folder,folder2 ,referenceVideosList[0]), "-d", os.path.join(fp.paths.testDataDir,folder,folder2,distortedVideosList[0])]
...
TC_9_3_ClassObject = TC_9_3_Class()
