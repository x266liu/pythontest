...
class TC_9_8_Class(object):
    ...
    def run_TC_9_8(self, elemetnAttributeDictionary):
        ...
        generateTestResultFile.testResultObject.writeInTestFile(",,test reference input video:\n")
...
TC_9_8_ClassObject = TC_9_8_Class()
