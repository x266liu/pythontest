...
class SSIMWaveCommandBasedVersionTesting:
    ...
    def __init__(self, starting_Index_Of_TC, ending_Index_Of_TC):
        ...
        self.starting_Index_Of_TC = [1.1]     
        self.ending_Index_Of_TC = [11.3]
        fp.produceGolden = 0 ;
        fp.screenshot =0 ;
    ...
    def tc_num_getstartandend(self, start,end, ref ):
        ...
        if(size_start == 3 ):
            if(start[0]==ref[0] and start[1]== ref[1]):
                fp.num3start_end_Index_Of_TC[0] = start[2]
                if(size_end == 3 ):
                    if(start[0]==end[0] and start[1]==end[1]):
                        fp.num3start_end_Index_Of_TC[1] = end[2]
                    return ;

        if( size_end ==3):
            if(end[0]==ref[0] and end[1]== ref[1]):
                fp.num3start_end_Index_Of_TC[1] = end[2] ;
        return ;     
    ...
    def tc_num_gte(self, isGreater, ref,mode):
        ...
        if size1 == 3 and size2 == 2 and mode ==1:
            if  isGreater[0] == ref[0] and isGreater[1] == ref[1] :
                return 1  ;
